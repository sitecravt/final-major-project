...
export default function AboutPage() {
  return (
    ...
    <div className='flex justify-center'>
        <Image className='grayscale' src={"/aboutimage.png"} alt='aboutimage' width={1493} height={555}/>
    </div>
    ...
    <button  className='bg-[#d02626] p-5 rounded-[12px] text-[20px] w-[198px] text-white mt-[30px] ml-[155px] '><Link href="/info">Read More</Link></button>
</div>
  )
}
